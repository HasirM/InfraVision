        ...
        <section class="breadcrumb-area">
            <div class="container">
                <div class="breadcrumb-content" data-aos="fade-up">
                    <p>ABOUT US</p>
                    <h1 class="section-heading"><img src="../assets/images/star-2-2.png" alt="Star"> Aesthetic design for brand <br>new startup <img src="../assets/images/star-2-2.png" alt="Star"></h1>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                <div data-aos="zoom-in">
                    <div class="d-flex project-infos-wrap shadow-box mb-24">
                        <img src="../assets/images/icon2-2.png"alt="Icon">
