...
if (isset($_GET['searchInput'])) {
    ...
    $sql = "SELECT * FROM reports WHERE status LIKE '%$searchInput%' OR severity LIKE '%$searchInput%' OR id LIKE '%$searchInput%' OR location LIKE '%$searchInput%'";
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <?php foreach ($reports as $report): ?>
                            ...
                            <div data-aos="zoom-in" class="flex-1 report-box <?= $report['status']?>">
